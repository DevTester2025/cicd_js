...
export class SSLService {
  ...
  constructor(private httpHandler: HttpHandlerService) {
    ...
    this.serviceURL = AppConstant.API_CONFIG.API_URL.MONITORING.SSL;
  }
  import(data): Observable<any> {
    return this.httpHandler.POST(this.endpoint + this.serviceURL.IMPORT, data);
  }
  ...
  monitoringUpdate(data): Observable<any> {
    return this.httpHandler.POST(this.endpoint + this.serviceURL.MONITORINGUPDATE, data);
  }
