...
export class SLATemplatesService {
  ...
  constructor(private httpHandler: HttpHandlerService) {
    ...
    this.serviceURL = AppConstant.API_CONFIG.API_URL.TENANTS.SLA.SLATEMPLATES;
  }
  ...
  byId(id,query?): Observable<any> {
    let url = this.endpoint + this.serviceURL.FINDBYID;
    if (query) url += query;
    return this.httpHandler.GET(url + id);
  }
